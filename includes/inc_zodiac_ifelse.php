<div id='ifElseContent'>
    ...
    //To display the form:
        function displayForm($error){
            ...
            <form class='form-inline' role='form' id='ifElseForm' action='index.php?page=ifElse' method='POST'>
